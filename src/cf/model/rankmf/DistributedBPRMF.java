...
import cf.optimization.gradient.rank.AUCLoss;
import cf.optimization.gradient.rank.DistributedSGDBPR;
...
public class DistributedBPRMF extends AbstractMF {
	...
	public void predictPair(String inputPath, int numD) throws Exception {
		...
		Configuration conf = FileOperators.getConfiguration();
		DistributedMFPrediction.predictPair(inputPath, conf.get("hadoop.output.path"), "cf.model.rankmf.DistributedBPRMF", numD);
	}
	////////////////////////////////////////////////////////////////////////////////////////////////////////
	@Deprecated
	...
	public void predictAll() throws Exception {
		Configuration conf = FileOperators.getConfiguration();
		DistributedMFPrediction.predictAll(conf.get("hadoop.output.path"), "cf.model.rankmf.DistributedBPRMF");			
	}
}
